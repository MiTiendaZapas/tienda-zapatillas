/* Header (con menú de celular) y hero, armados desde la configuración de la tienda. */
  ...
  root.innerHTML = `
    <div class="container site-header__inner">
      ...
      <div class="site-header__actions">
        <a class="icon-btn" href="${consult}" target="_blank" rel="noopener" aria-label="Consultar por WhatsApp" title="Consultar por WhatsApp">
          ${icon("whatsapp")}
        </a>
    ...
    <div class="menu-sheet__panel">
      ...
      <div class="menu-sheet__footer">
        ...
        <ul class="social-list">
          ${(config.social ?? []).map((s) => `
            <li><a class="social-link" href="${escapeHtml(s.url)}" target="_blank" rel="noopener" aria-label="${escapeHtml(s.label)}">${icon(s.network)}</a></li>`).join("")}
        </ul>
      </div>
    </div>`;
...
export function renderHero(root, { channel, links }) {
