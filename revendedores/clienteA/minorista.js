...
// Precio MAYOR de TODA la línea "Mind" (ojotas). El precio por unidad de
// Mind en ESTA tienda no tiene excepción propia: usa el mismo flat de
// $49.000 que el resto del catálogo, así que no hace falta declararlo acá.
const PRECIO_MIND_MAYOR = 35000;
...
function obtenerPrecioMayorista(nombreProducto) {
    ...
    // PRECIOS DE 41.000 EN LA TIENDA PRINCIPAL -> ACÁ $42.000
    ...
    // PRECIOS DE 39.000 EN LA TIENDA PRINCIPAL -> ACÁ $39.500
    ...
    // 2. CATEGORÍAS GENERALES. EN LA TIENDA PRINCIPAL VALEN 37.000 -> ACÁ $36.500
...
function cargarProductos() {
    ...
    stock_actualizado.forEach((producto, index) => {
        ...
        if (esIndumentaria) {
            ...
            textoMayoristaHtml = `<div style="font-size: 12px; color: #28a745; margin-bottom: 6px; font-weight: bold;">Llevando 3 o más: $${precioMayorista.toLocaleString('es-AR')}</div>`;
        }
...
function actualizarCarrito() {
    ...
    let esMayoristaZapas = (sumaParesZapas >= 3);
    let totalPrecio = 0;
